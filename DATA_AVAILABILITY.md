...
The datasets used in this study for both binary and multiclass classification tasks are **publicly available through the Kaggle repository**:

- **MSLD Dataset (Binary classification)**  
  [https://www.kaggle.com/datasets/nafin59/monkeypox-skin-lesion-dataset](https://www.kaggle.com/datasets/nafin59/monkeypox-skin-lesion-dataset)

- **MSLD v2.0 Dataset (Multiclass classification, 6 classes)**  
